...
import { roadmap_sol } from "../constants";  
        ...
        <div className="relative">           
          {roadmap_sol.map((item, index) => {             
            ...
            return (               
              <div                 
                key={item.id}                
                className={` flex flex-col md:flex-row bg-[#15131D] p-6 rounded-3xl items-center justify-between mb-10 md:mb-20                    
